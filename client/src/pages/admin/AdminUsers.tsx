...
import { fetchAdminUsers, adminChangeUserRole, adminDeleteUser } from "../../api/adminUsers";
      ...
      <div className="mx-auto w-full max-w-6xl">
        <div className="relative overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-lg">
          ...
          <div className="relative z-10 p-6 sm:p-10 text-white">
            ...
            <h1 className="mt-2 text-3xl sm:text-4xl font-extrabold tracking-tight">Korisnici</h1>
            <p className="mt-2 text-sm text-white/85 max-w-2xl">Upravljanje korisnicima: uloge i brisanje.</p>
          </div>
        </div>
          ...
          <div className="p-4 sm:p-6">
            ...
            {loading ? (
              ...
              <div className="mt-4 grid gap-3">
                {items.map((u) => (
                  <div key={u.id} className="relative overflow-hidden rounded-3xl border border-gray-200 bg-white">
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                        <div className="min-w-0">
                          ...
                          <div className="mt-2 text-xs text-gray-500">
                            {u.country}, {u.street} {u.streetNumber} • DOB: {u.dateOfBirth} • Pol: {String(u.gender ?? "")}
                          </div>
                        </div>
                    ...
                    <div className="p-4 sm:p-5 flex justify-end">
                      <Button variant="danger" className="rounded-2xl" onClick={() => remove(u.id)}>
                        Obriši korisnika
                      </Button>
                    </div>
                  </div>
